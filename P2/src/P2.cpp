...
int main() {
	...
	FuncaoAgregada f;
	f.agrega(new Potencial(2));
	f.agrega(new Escalar(5, new Seno(new FuncaoAgregada(new Escalar(2), new Constante(-1)))));
	...
	cout << "A integral de [0,5] é " << Funcao::integrar(&f, 0, 5, 0.000001) << endl;
	return 0;
}
